...
function showLogin(message=""){ $("#login-screen").hidden=false; $(".admin-shell").hidden=true; $("#login-description").textContent=message||"Masukkan kata sandi admin untuk melanjutkan."; $("#login-submit").textContent="Masuk"; }
